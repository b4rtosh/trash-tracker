...
DATABASES = {
    "default": {
        ...
        "HOST": os.environ.get(
            "DATABASE_WRITER_HOST", os.environ.get("DATABASE_HOST", "localhost")
        ),
    ...
    "replica": {
        ...
        "PASSWORD": os.environ.get("DATABASE_PASSWORD", "adminpass"),
        "HOST": os.environ.get(
            "DATABASE_READER_HOST", os.environ.get("DATABASE_HOST", "localhost")
        ),
        "PORT": os.environ.get("DATABASE_PORT", "3306"),
        "OPTIONS": {
            "connect_timeout": 10,
...
SESSION_COOKIE_NAME = "trash_tracker_sessionid"
